...
{{-- for content after card --}}
	...
	<div class="row">
		<div class="col-12">
			<form action="{{route('food.store')}}" onsubmit="return submit_button()" enctype="multipart/form-data" method="post">
			@csrf
				<div class="card">
					<div class="card-header" style="background-color: black; text-align: center; font-weight: bold; 
					color:white; font-size: 25px;">Create Food Menu</div>
					<div class="card-body">
						<div class="row">
							<div class="col-sm-6">
								<div style="color:black; font-size:15px"> Name : </div> 
								
								<div> <input class="form-control" type="" name="name" id="name" placeholder="Enter food name"required autofocus></div>
								
							</div>

							<div class="col-sm-6">
								<div style="color:black; font-size:15px"> Price : </div>
								 <div> <input class="form-control" type="number" step="0.000001" name="price" id="price" placeholder="Enter food price"required autofocus></div>
							</div>
						</div>
						...
						<div class="row mt-3">
							<div class="col-sm-12">
								...
								<div> <textarea class="form-control" rows="2" name="desc" id="desc" placeholder="Up to 300 characters" autofocus></textarea></div>
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<div style="color:black; font-size:15px" class="mb-3 mt-3">Requirements :</div>	
							</div>
						</div>
					...
					<div class="card-body">
						<div class="row">
							<div class="col-sm-6">
								...
								<div> <input class="form-control" type="" name="" id="name" required></div>
							...
							<div class="col-sm-6">
								<div style="color:black; font-size:15px"> Price : </div>
								 <div> <input class="form-control" type="number" step="0.000001" id="price" onkeyup="f_price()"></div>
