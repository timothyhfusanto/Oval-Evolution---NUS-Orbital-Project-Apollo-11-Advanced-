...
{{-- for content after card --}}
	...
	<div class="row mb-3 mt-4" style="align-items: center;">
		<div class="col-md-1">		
			<a href="/staff/food" style="color:#59ceb5; border-bottom:1px solid #59ceb5; font-size:16px">
				Food
			</a>
		</div>
		<div class="col-md-1" >
			<a href="/staff/drink" style="color:#BABABA; font-size:16px">
				Beverage
			</a>
		</div>
						...
						border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                            	...
                            	<tr>
                            		...
                            		<td>
										<a href="{{route('food.edit',[$dataindex0->id])}}">
											<i class="fas fa-edit mb-2" style="font-size: 17px;"></i>
										</a>
										<form action="{{route('food.destroy',[$dataindex0->id])}}" method="post">@csrf {{method_field('delete')}}
											<button type="summit" onclick="return confirm('Are you sure to delete this item?')">
