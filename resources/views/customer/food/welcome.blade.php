...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="background-color:#EAEFF2;">
        ...
        <header class="header-block">
            <svg width="90%" height="90%" viewBox="0 0 10000 1000" version="1.1" xmlns="http://www.w3.org/2000/svg" 
            ...
            <ul class="nav-menu">
                <li type="button" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    FOODS
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="/">All Foods</a>
                        <a class="dropdown-item" href="/favourites">Favourites <i class="fas fa-heart"></i></a>
                    </div>
                </li>
                <li type="button" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    DRINKS
