                ...
                <div class="search-bar ml-5">
                    <form action="{{route('searched.index')}}" method="get">
                        ...
                        <div class="input-group">
                            <input required value="{{$searchedProduct}}"name="product_name" type="search" class="form-control" id="search_product" placeholder="Search food..." aria-label="Username" aria-describedby="basic-addon1">
