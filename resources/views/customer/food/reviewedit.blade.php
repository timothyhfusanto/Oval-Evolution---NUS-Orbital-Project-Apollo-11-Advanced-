    ...
    <body style="background-color: #EAEFF2; font-family:Roboto; color:black">
       ...
       <header class="header-block">
        ...
        @endif
            ...
            <form action="{{ route('review.update', ['id' => $food->id, 'user_id' => $dataedit->user_id]) }}" method="post" enctype="multipart/form-data"> @csrf {{method_field('patch')}}
                    ...
                    <div class="card mt-2" style="box-shadow: 0 0 10px 0 #ddd; border-radius:10px;background-color:white">
                        ...
                        <div class="row ml-2 mb-3">
                            <div class="col" style="display: flex;">
                                <input type="hidden" value="{{Auth::user()->profile_image}}" name="user_profile">
